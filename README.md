...
* **Obtener Tamaño Inicial:** http://localhost:8080/api/v1/tamanyo
* **Insertar Primer Estudiante:** http://localhost:8080/api/v1/insertar?codigo=101&nombres=Juan&apellidos=Moya&email=est.juanantonio.moya.ob@unifranz.edu.bo&fechaNacimiento=2000-01-01&genero=M
* **Insertar Segundo Estudiante:** http://localhost:8080/api/v1/insertar?codigo=102&nombres=Carlos&apellidos=Perez&email=carlos@email.com&fechaNacimiento=2001-05-10&genero=M
